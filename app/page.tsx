    ...
    <PageTransition className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 selection:bg-emerald-800 selection:text-white font-sans antialiased">
      <main className="max-w-4xl mx-auto px-8 md:px-16 py-32 md:py-48">
        ...
        <Reveal><section className="mb-32 max-w-3xl" aria-labelledby="hero-heading">
          <div className="space-y-8">
            <div className="space-y-6">
              <h1 id="hero-heading" className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light tracking-tight leading-[1.1] text-zinc-900 dark:text-zinc-100">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-zinc-600 dark:text-zinc-400 leading-relaxed font-light max-w-2xl">
              Focused on creating systems where <span className="text-zinc-900 dark:text-zinc-100 font-medium italic">technical precision</span> meets functional design. 
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-8">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <span className="text-[10px] uppercase tracking-[0.3em] text-zinc-500 dark:text-zinc-400 font-medium">English C1 Proficiency</span>
              </div>
              <div className="hidden md:block h-4 w-px bg-zinc-200 dark:bg-zinc-700" aria-hidden="true" />
              <a
                href={LINKS.cv}
                target="_blank"
        ...
        <Reveal delay={0.2}><section className="mb-32" aria-labelledby="skills-heading">
          <h2 id="skills-heading" className="text-[10px] uppercase tracking-[0.5em] text-zinc-500 dark:text-zinc-400 mb-24 font-medium">
            CORE CAPABILITIES
          </h2>
        ...
        <Reveal delay={0.35}>
          <section className="mb-32" aria-labelledby="testimonials-heading">
            <div className="flex flex-col sm:flex-row justify-between items-end gap-8 mb-20 border-b border-zinc-100 dark:border-zinc-800 pb-6">
              ...
              <span className="text-[10px] text-zinc-400 dark:text-zinc-500 font-mono italic">Social Proof</span>
            </div>
            <Testimonials />
          </section>
        </Reveal>

        <Reveal delay={0.4}><footer className="border-t border-zinc-100 dark:border-zinc-800 pt-32 pb-16">
